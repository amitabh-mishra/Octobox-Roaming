...
while(create_sweep == "Y" or create_sweep == "y"):
    ...
    destination = user_sweep_workbook.get_sheet_by_name("Sheet")

    # xlsx_to_csv = pd.read_excel(sweep_xlsx_filepath, sheet_name = "csv").to_csv(sweep_config_fileName, index = False)
